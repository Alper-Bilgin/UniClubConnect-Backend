...
public abstract class AbstractEventBadgeRule implements BadgeRule {
    ...
    public boolean supports(EventType eventType) {
        return eventType == EventType.EVENT_JOINED;
    }
    ...
    public boolean checkCondition(GamificationEvent event) {
        ...
        return userPoint != null && userPoint.getEventCount() >= targetCount;
    }
