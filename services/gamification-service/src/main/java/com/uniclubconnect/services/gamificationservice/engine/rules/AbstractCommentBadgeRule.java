...
public abstract class AbstractCommentBadgeRule implements BadgeRule {
    ...
    public boolean supports(EventType eventType) {
        return eventType == EventType.COMMENT_ADDED;
    }
    ...
    public boolean checkCondition(GamificationEvent event) {
        ...
        return userPoint != null && userPoint.getCommentCount() >= targetCount;
    }
