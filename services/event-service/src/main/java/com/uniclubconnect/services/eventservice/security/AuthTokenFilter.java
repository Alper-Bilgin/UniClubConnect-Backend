package com.uniclubconnect.services.eventservice.security;

import com.uniclubconnect.services.eventservice.security.dto.UserPrincipal;
...
public class AuthTokenFilter extends OncePerRequestFilter {
    ...
    // JwtUtils'i kurucu metot (constructor) ile al
    public AuthTokenFilter(JwtUtils jwtUtils) {
        this.jwtUtils = jwtUtils;
    }

    // ... (doFilterInternal ve parseJwt metotları aynı kalabilir) ...
    // ... (Kodunuzda bir hata yoktu, sadece tanımlanma şeklinde hata vardı) ...
